      ...
      <div className="max-w-6xl mx-auto px-6 py-20 space-y-32">
        ...
        <section className="space-y-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {content.history.map((card, i) => {
              ...
              return (
                <div key={i} className="bg-white dark:bg-slate-900/40 p-8 rounded-3xl border border-slate-200 dark:border-white/5 hover:border-yellow-500/50 transition-all shadow-sm dark:shadow-none">
        ...
        <section className="space-y-12">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {values.map((v, i) => (
              <div key={i} className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-white/5 p-8 rounded-3xl hover:border-yellow-500 transition-all group shadow-sm dark:shadow-none">
